        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-slate-400 font-normal">
              ...
              <li className="pt-1 border-t border-slate-800/60"><Link to="/admin/login" className="text-orange-400 font-bold hover:text-orange-300 hover:translate-x-0.5 inline-flex items-center gap-1 transition-all">🛡️ {t.adminCockpit || (lang === 'ta' ? 'நிர்வாகி போர்ட்டல்' : 'Admin Portal Cockpit')}</Link></li>
            </ul>
          </div>
